	    ...
	    <div class="container">
	      ...
	      <div class="row">
	        ...
	        <div class="col-lg-3 col-md-6">
	          <div class="single-product">
	            <div class="product-img">
	              <img class="img-fluid w-100" src="${context}/resources/img/product/inspired-product/i5.jpg" alt="" />
	              <div class="p_icon">
	                <a href="#">
	                  <i class="ti-eye"></i>
	                </a>
	        ...
	        <div class="col-lg-3 col-md-6">
	          <div class="single-product">
	            <div class="product-img">
	              <img class="img-fluid w-100" src="${context}/resources/img/product/inspired-product/i6.jpg" alt="" />
	              <div class="p_icon">
	                <a href="#">
	                  <i class="ti-eye"></i>
	                </a>
	        ...
	        <div class="col-lg-3 col-md-6">
	          <div class="single-product">
	            <div class="product-img">
	              <img class="img-fluid w-100" src="${context}/resources/img/product/inspired-product/i7.jpg" alt="" />
	              <div class="p_icon">
	                <a href="#">
	                  <i class="ti-eye"></i>
	                </a>
	        ...
	        <div class="col-lg-3 col-md-6">
	          <div class="single-product">
	            <div class="product-img">
	              <img class="img-fluid w-100" src="${context}/resources/img/product/inspired-product/i8.jpg" alt="" />
	              <div class="p_icon">
	                <a href="#">
	                  <i class="ti-eye"></i>
	                </a>
